...
- (void) addFaceFrame {
    ...
    width = (1280 / (2.0F / (self.view.bounds.size.height / 1280)));
    height = (720 / (0.8F / (self.view.bounds.size.width / 720)));
    
    self.frame = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"face_frame_magenta.png"]];
    // Define o tamanho
    [self.frame setFrame:CGRectMake(0, 0, width, height)];
    // Centralize o frame
    [self.frame setCenter:CGPointMake(self.view.bounds.size.width / 2, self.view.bounds.size.height / 2)];

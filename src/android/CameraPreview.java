...
public class CameraPreview extends CordovaPlugin implements CameraActivity.CameraPreviewListener {
  ...
  private final String SET_ON_PICTURE_TAKEN_HANDLER_ACTION = "setOnPictureTakenHandler";
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    ...
    if (START_CAMERA_ACTION.equals(action)) {
      ...
      return takePicture(args.getInt(0), args.getInt(1), callbackContext);
    ...
    } else if (SET_ON_PICTURE_TAKEN_HANDLER_ACTION.equals(action)) {
  ...
  private boolean takePicture(int width, int height, CallbackContext callbackContext) {
    if(this.hasView(callbackContext) == false){
      return true;
    }

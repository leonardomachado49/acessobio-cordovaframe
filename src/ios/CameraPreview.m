...
- (void) startCamera:(CDVInvokedUrlCommand*)command {
    ...
    if (command.arguments.count > 3) {
        ...
        [self.sessionManager setupSession:defaultCamera completion:^(BOOL started) {
            ...
            NSError *error = nil;
            AVCaptureDevice *videoDevice = [CameraPreview deviceWithMediaType:AVMediaTypeVideo preferringPosition:self.sessionManager.defaultCamera];
...
- (void) invokeTakePicture:(CGFloat) width withHeight:(CGFloat) height {
